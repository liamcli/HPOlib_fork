...
wait
for k in $(seq 1 185); do 
	rsync -a -f"+ */" -f"+ *.pkl" -f"+ *.out" -f"- *" ${instances_list[$k]}.us-central1-f.stately-will-107018:/home/lisha_c_li/HPOlib/benchmarks/auto-sklearn/nocv/ autosklearn/holdout_noprec5k
done
wait
