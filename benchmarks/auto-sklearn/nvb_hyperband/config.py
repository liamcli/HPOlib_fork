...
def param_140(classifier):
    return hp.choice("preprocessor:"+classifier+":__choice__", [
...
#Preprocessors without kitchen sink and nystroem
def param_142(classifier):
    return hp.choice("preprocessor:"+classifier+":__choice__", [
    {"preprocessor:__choice__": "extra_trees_preproc_for_classification", "preprocessor:extra_trees_preproc_for_classification:bootstrap": param_90, "preprocessor:extra_trees_preproc_for_classification:criterion": param_91, "preprocessor:extra_trees_preproc_for_classification:max_depth": param_92, "preprocessor:extra_trees_preproc_for_classification:max_features": param_93, "preprocessor:extra_trees_preproc_for_classification:min_samples_leaf": param_94, "preprocessor:extra_trees_preproc_for_classification:min_samples_split": param_95, "preprocessor:extra_trees_preproc_for_classification:min_weight_fraction_leaf": param_96, "preprocessor:extra_trees_preproc_for_classification:n_estimators": param_97, },
    {"preprocessor:__choice__": "fast_ica", "preprocessor:fast_ica:algorithm": param_98, "preprocessor:fast_ica:fun": param_99, "preprocessor:fast_ica:whiten": param_101, },
    {"preprocessor:__choice__": "feature_agglomeration", "preprocessor:feature_agglomeration:affinity": param_102, "preprocessor:feature_agglomeration:linkage": param_103, "preprocessor:feature_agglomeration:n_clusters": param_104, "preprocessor:feature_agglomeration:pooling_func": param_105, },
...
#Preprocessor without kitchen sink, nystroem, or random trees embedding
def param_143(classifier):
    return hp.choice("preprocessor:"+classifier+":__choice__", [
    {"preprocessor:__choice__": "extra_trees_preproc_for_classification", "preprocessor:extra_trees_preproc_for_classification:bootstrap": param_90, "preprocessor:extra_trees_preproc_for_classification:criterion": param_91, "preprocessor:extra_trees_preproc_for_classification:max_depth": param_92, "preprocessor:extra_trees_preproc_for_classification:max_features": param_93, "preprocessor:extra_trees_preproc_for_classification:min_samples_leaf": param_94, "preprocessor:extra_trees_preproc_for_classification:min_samples_split": param_95, "preprocessor:extra_trees_preproc_for_classification:min_weight_fraction_leaf": param_96, "preprocessor:extra_trees_preproc_for_classification:n_estimators": param_97, },
    {"preprocessor:__choice__": "fast_ica", "preprocessor:fast_ica:algorithm": param_98, "preprocessor:fast_ica:fun": param_99, "preprocessor:fast_ica:whiten": param_101, },
    {"preprocessor:__choice__": "feature_agglomeration", "preprocessor:feature_agglomeration:affinity": param_102, "preprocessor:feature_agglomeration:linkage": param_103, "preprocessor:feature_agglomeration:n_clusters": param_104, "preprocessor:feature_agglomeration:pooling_func": param_105, },
...
#Preprocessor for multinomial naive bayes without a bunch of preprocessors
def param_144(classifier):
    return hp.choice("preprocessor:"+classifier+"__choice__", [
    {"preprocessor:__choice__": "extra_trees_preproc_for_classification", "preprocessor:extra_trees_preproc_for_classification:bootstrap": param_90, "preprocessor:extra_trees_preproc_for_classification:criterion": param_91, "preprocessor:extra_trees_preproc_for_classification:max_depth": param_92, "preprocessor:extra_trees_preproc_for_classification:max_features": param_93, "preprocessor:extra_trees_preproc_for_classification:min_samples_leaf": param_94, "preprocessor:extra_trees_preproc_for_classification:min_samples_split": param_95, "preprocessor:extra_trees_preproc_for_classification:min_weight_fraction_leaf": param_96, "preprocessor:extra_trees_preproc_for_classification:n_estimators": param_97, },
    {"preprocessor:__choice__": "feature_agglomeration", "preprocessor:feature_agglomeration:affinity": param_102, "preprocessor:feature_agglomeration:linkage": param_103, "preprocessor:feature_agglomeration:n_clusters": param_104, "preprocessor:feature_agglomeration:pooling_func": param_105, },
    {"preprocessor:__choice__": "liblinear_svc_preprocessor", "LOG10_preprocessor:liblinear_svc_preprocessor:C": param_88, "LOG10_preprocessor:liblinear_svc_preprocessor:tol": param_89, "preprocessor:liblinear_svc_preprocessor:dual": param_114, "preprocessor:liblinear_svc_preprocessor:fit_intercept": param_115, "preprocessor:liblinear_svc_preprocessor:intercept_scaling": param_116, "preprocessor:liblinear_svc_preprocessor:loss": param_117, "preprocessor:liblinear_svc_preprocessor:multi_class": param_118, "preprocessor:liblinear_svc_preprocessor:penalty": param_119, },
...
param_82 = hp.choice("classifier:__choice__", [
    {"classifier:__choice__": "adaboost","preprocessor:adaboost:__choice__": param_142("adaboost"), "LOG10_classifier:adaboost:learning_rate": param_4, "classifier:adaboost:algorithm": param_15, "classifier:adaboost:max_depth": param_16, "classifier:adaboost:n_estimators": param_17, },
    {"classifier:__choice__": "decision_tree", "preprocessor:decision_tree:__choice__": param_142("decision_tree"),"classifier:decision_tree:criterion": param_18, "classifier:decision_tree:max_depth": param_19, "classifier:decision_tree:max_features": param_20, "classifier:decision_tree:max_leaf_nodes": param_21, "classifier:decision_tree:min_samples_leaf": param_22, "classifier:decision_tree:min_samples_split": param_23, "classifier:decision_tree:min_weight_fraction_leaf": param_24, "classifier:decision_tree:splitter": param_25, },
    {"classifier:__choice__": "extra_trees", "preprocessor:extra_trees:__choice__": param_142("extra_trees"),"classifier:extra_trees:bootstrap": param_26, "classifier:extra_trees:criterion": param_27, "classifier:extra_trees:max_depth": param_28, "classifier:extra_trees:max_features": param_29, "classifier:extra_trees:min_samples_leaf": param_30, "classifier:extra_trees:min_samples_split": param_31, "classifier:extra_trees:min_weight_fraction_leaf": param_32, "classifier:extra_trees:n_estimators": param_33, },
    {"classifier:__choice__": "gaussian_nb", "preprocessor:gaussian_nb:__choice__": param_143("gaussian_nb"),},
    {"classifier:__choice__": "gradient_boosting", "preprocessor:gradient_boosting:__choice__": param_143("gradient_boosting"),"LOG10_classifier:gradient_boosting:learning_rate": param_5, "classifier:gradient_boosting:loss": param_34, "classifier:gradient_boosting:max_depth": param_35, "classifier:gradient_boosting:max_features": param_36, "classifier:gradient_boosting:max_leaf_nodes": param_37, "classifier:gradient_boosting:min_samples_leaf": param_38, "classifier:gradient_boosting:min_samples_split": param_39, "classifier:gradient_boosting:min_weight_fraction_leaf": param_40, "classifier:gradient_boosting:n_estimators": param_41, "classifier:gradient_boosting:subsample": param_42, },
    {"classifier:__choice__": "k_nearest_neighbors", "preprocessor:knn:__choice__": param_142("knn"),"LOG10_Q1_classifier:k_nearest_neighbors:n_neighbors": param_1, "classifier:k_nearest_neighbors:p": param_43, "classifier:k_nearest_neighbors:weights": param_44, },
    {"classifier:__choice__": "lda", "preprocessor:lda:__choice__": param_143("lda"),"LOG10_classifier:lda:tol": param_6, "classifier:lda:n_components": param_45, "classifier:lda:shrinkage": param_47, },
    {"classifier:__choice__": "liblinear_svc", "preprocessor:liblinear:__choice__": param_140("liblinear"),"LOG10_classifier:liblinear_svc:C": param_7, "LOG10_classifier:liblinear_svc:tol": param_8, "classifier:liblinear_svc:dual": param_48, "classifier:liblinear_svc:fit_intercept": param_49, "classifier:liblinear_svc:intercept_scaling": param_50, "classifier:liblinear_svc:loss": param_51, "classifier:liblinear_svc:multi_class": param_52, "classifier:liblinear_svc:penalty": param_53, },
    {"classifier:__choice__": "libsvm_svc","preprocessor:libsvm:__choice__": param_142("libsvm"),"LOG10_classifier:libsvm_svc:C": param_9, "LOG10_classifier:libsvm_svc:gamma": param_10, "LOG10_classifier:libsvm_svc:tol": param_11, "classifier:libsvm_svc:kernel": param_56, "classifier:libsvm_svc:max_iter": param_57, "classifier:libsvm_svc:shrinking": param_58, },
    {"classifier:__choice__": "multinomial_nb","preprocessor:multinomial_nb:__choice__": param_144("multinomial_nb"), "LOG10_classifier:multinomial_nb:alpha": param_12, "classifier:multinomial_nb:fit_prior": param_59, },
    {"classifier:__choice__": "passive_aggressive","preprocessor:passive_agg:__choice__": param_140("passive_agg"), "LOG10_Q1_classifier:passive_aggressive:n_iter": param_2, "LOG10_classifier:passive_aggressive:C": param_13, "classifier:passive_aggressive:fit_intercept": param_60, "classifier:passive_aggressive:loss": param_61, },
    {"classifier:__choice__": "proj_logit", "preprocessor:proj_logit:__choice__": param_143("proj_logit"),"classifier:proj_logit:max_epochs": param_62, },
    {"classifier:__choice__": "qda", "preprocessor:qda:__choice__": param_143("qda"),"classifier:qda:reg_param": param_63, },
    {"classifier:__choice__": "random_forest", "preprocessor:rf:__choice__": param_142("rf"),"classifier:random_forest:bootstrap": param_64, "classifier:random_forest:criterion": param_65, "classifier:random_forest:max_depth": param_66, "classifier:random_forest:max_features": param_67, "classifier:random_forest:max_leaf_nodes": param_68, "classifier:random_forest:min_samples_leaf": param_69, "classifier:random_forest:min_samples_split": param_70, "classifier:random_forest:min_weight_fraction_leaf": param_71, "classifier:random_forest:n_estimators": param_72, },
    {"classifier:__choice__": "sgd", "preprocessor:sgd:__choice__": param_140("sgd"),"LOG10_Q1_classifier:sgd:n_iter": param_3, "LOG10_classifier:sgd:alpha": param_14, "classifier:sgd:average": param_73, "classifier:sgd:eta0": param_74, "classifier:sgd:fit_intercept": param_75, "classifier:sgd:learning_rate": param_77, "classifier:sgd:loss": param_79, "classifier:sgd:penalty": param_81, },
    ])
...
space = {"balancing:strategy": param_0, "classifier:__choice__": param_82, "imputation:strategy": param_83, "one_hot_encoding:use_minimum_fraction": param_85, "rescaling:__choice__": param_141}
