...
space = {'learning_rate': hp.loguniform('learning_rate', np.log(5*10**(-5)), np.log(5)),
        'weight_cost1': hp.loguniform('weight_cost1', np.log(5*10**(-5)), np.log(5)),
        'weight_cost2': hp.loguniform('weight_cost2', np.log(5*10**(-5)), np.log(5)),
        'weight_cost3': hp.loguniform('weight_cost3', np.log(5*10**(-5)), np.log(5)),
        'weight_cost4': hp.loguniform('weight_cost4', np.log(5*10**(-3)), np.log(500)),
	'scale': hp.loguniform('scale', np.log(5*10**(-6)), np.log(5)),
	'power': hp.uniform('power', 0.01,3),
	'lr_step': hp.quniform('lr_step', 0.5, 4.5,1),
